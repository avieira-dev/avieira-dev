...
<h2 align="center" style="font-weight:900;">Game Engine & Graphics Systems</h2>
...
- **Interact UI** *(Design phase)*  
  Immediate mode GUI library for C++, designed for engine tools and editors.

- **Ptah Engine** *(Planning phase)*  
  Custom game engine being built from scratch in C++, focused on performance, modular architecture, and low-level control.

---

<h3 align="left">🧠 Systems & Core</h3>

<p align="center">
    <img src="assets/icons/linux.svg" width="60" title="Linux" alt="Linux"/>
    <img src="assets/icons/language-c.svg" width="60" title="C language" alt="C language"/>
    <img src="assets/icons/cpp.svg" width="60" title="C++" alt="C++"/>
    <img src="assets/icons/cmake.svg" width="60" title="CMake (build system)" alt="CMake (build system)"/>
</p>

---

<h3 align="left">🎮 Graphics & Rendering</h3>

<p align="center">
    <img src="assets/icons/opengl.svg" width="60" title="OpenGL (graphics API)" alt="OpenGL (graphics API)"/>
    <img src="assets/icons/vulkan.svg" width="60" title="Vulkan (graphics API)" alt="Vulkan (graphics API)"/>
</p>
...
<p align="center">
    ...
    <img src="assets/icons/blender.svg" width="60" title="Blender (3D modeling)" alt="Blender (3D modeling)"/>
    <img src="assets/icons/unreal.svg" width="60" title="Unreal Engine" alt="Unreal Engine"/>
    <img src="assets/icons/git.svg" width="60" title="Git (version control)" alt="Git (version control)"/>
